      ...
      <div className="form-card">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-4">
          <div>
            ...
            <input type="text" id="txtNombre" value={nombre} onChange={(e) => setNombre(e.target.value)} className="form-input" placeholder="Nombre de la película"/>
          </div>
          <div>
          ...
          <table className="table-element">
            <thead className="table-head">
              <tr>
                ...
                <th className="table-head-cell text-left">Estreno</th>
                ...
                <th className="table-head-cell text-left">Registró</th>
              </tr>
            </thead>
            <tbody className="table-body">
              {peliculasFiltradas.map((pelicula) => (
                <tr key={pelicula.Codigo} className="table-body-row">
                  ...
                  <td className="table-body-cell font-mono">{pelicula.Codigo}</td>
