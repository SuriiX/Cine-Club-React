      ...
      <div className="form-card">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-4">
          <div>
            ...
            <input type="text" id="txtNombre" value={nombre} onChange={(e) => setNombre(e.target.value)} className="form-input" placeholder="Nombre del Director"/>
          </div>
          <div>
            ...
            <tbody className="table-body">
              {directoresFiltrados.map((director) => (
                <tr key={director.Codigo} className="table-body-row">
                  ...
                  <td className="table-body-cell font-mono">{director.Codigo}</td>
